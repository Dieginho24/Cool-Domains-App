...
import abiContain from './utils/abi.json';
...
const App = () => {
    const CONTRACT_ADDRESS = "0x4ffE2D7648ef6cb053E5bd283F8BB1Cc42e78007";
    const contractABI = abiContain.abi;
    ...
    const mintDomain = async () => {
  	...
  	const renderNotConnectedContainer = () => (
  		<div className="connect-wallet-container">
  			<img src="https://media1.giphy.com/media/Ykzq1upAfkTIxz4Rjh/giphy.gif?cid=ecf05e47pcehqg5byz95ifgq4z5rypkzuu1daizwmlrb2csb&rid=giphy.gif"
          alt="Happy gif" />
		...
		<div className="App">
			<div className="container">
				<div className="header-container">
					<header>
						<div className="left">
						<p className="title">🐱‍👤 Happy Name Service</p>
